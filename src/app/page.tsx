                    ...
                    <div>
                        ...
                        <div className="mb-6 grid gap-4">
                            <div className="batik-subtitle rounded-lg bg-white/5 border border-white/10 p-4 backdrop-blur-sm">
                                <div className="mb-1 text-xs uppercase tracking-wider text-white/60">Asal</div>
                            ...
                            <div className="batik-subtitle rounded-lg bg-white/5 border border-white/10 p-4 backdrop-blur-sm">
                                <div className="mb-1 text-xs uppercase tracking-wider text-white/60">Filosofi</div>
                                <div className="text-sm font-medium text-white/90">
                        ...
                        <div className="relative">
                            <div className="absolute -left-3 top-0 text-6xl font-serif text-white/10">"</div>
                ...
                <div className="relative h-64 sm:h-full">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div
                            ...
                            style={{ backgroundImage: "url('/assets/parang/vecteezy_batik-parang-style-illustration-for-background-wallpaper_48387544.jpg')", backgroundSize: '300%', backgroundPosition: 'center' }}
    ...
    >
        ...
        <div className="relative h-64 sm:h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div
                    className="h-72 w-72 rounded-full border border-white/30 bg-white/10 backdrop-blur-sm cursor-pointer transition-all duration-300 hover:scale-105 hover:border-white/50"
                    style={{ backgroundImage: "url('/assets/megamendung/bg.jpg')", backgroundSize: '300%', backgroundPosition: 'center' }}
                    title="Click to toggle background"
                />
            </div>
        </div>
    ...
    >
        ...
        <div className="relative h-64 sm:h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div
                    className="h-72 w-72 rounded-full border border-white/30 bg-white/10 backdrop-blur-sm cursor-pointer transition-all duration-300 hover:scale-105 hover:border-white/50"
                    style={{ backgroundImage: "url('/assets/kawung/highlight.png')", backgroundSize: '100%', backgroundPosition: 'center' }}
                    title="Click to toggle background"
                />
            </div>
        </div>
        ...
        <div className="p-8 sm:p-12 backdrop-blur-[2px] bg-gradient-to-br from-[#8B4513]/10 to-black/20 flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#8B4513]/20 border border-[#C9A87C]/20 px-4 py-2 backdrop-blur-sm">
                    <span className="text-sm font-medium text-[#E8D4B8]">Dedication & Patience</span>
                </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-[#8B4513]/15 to-[#5C3D2E]/10 border border-[#9B6B4C]/25 p-5 backdrop-blur-sm">
                    <div className="absolute -top-3 -left-2 text-5xl font-serif text-[#D4AF37]/20">"</div>
                    ...
                    <div className="absolute -bottom-3 -right-2 text-5xl font-serif text-[#D4AF37]/20 rotate-180">"</div>
                </div>
            </div>
        </div>
        <div className="relative h-64 sm:h-full bg-gradient-to-br from-[#8B4513]/20 to-[#5C3D2E]/10 overflow-hidden">
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: 'inset 0 0 80px rgba(139,69,19,0.4), inset 0 0 120px rgba(45,24,16,0.3)'
                }}
        ...
        <div className="p-8 sm:p-12 backdrop-blur-[2px] bg-gradient-to-br from-[#6D4C41]/15 to-black/25 flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#6D4C41]/25 border border-[#D4A574]/25 px-4 py-2 backdrop-blur-sm">
                    <svg className="w-3 h-3 text-[#D4A574]/70" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                    </svg>
                    <span className="text-sm font-medium text-[#E8D4B8]">Tradition & Togetherness</span>
                </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-[#6D4C41]/20 to-[#5D4037]/15 border border-[#D4A574]/25 p-5 backdrop-blur-sm">
                    <div className="absolute -top-3 -left-2 text-5xl font-serif text-[#D4A574]/20">"</div>
                    <p className="relative z-10 text-sm leading-relaxed text-[#E8D4B8] italic pl-4">
                        Komunitas adalah tempat warisan ini bertahan, berakar, dan tumbuh kembali.
                    </p>
                    <div className="absolute -bottom-3 -right-2 text-5xl font-serif text-[#D4A574]/20 rotate-180">"</div>
                </div>
            </div>
        </div>
        <div className="relative h-64 sm:h-full bg-gradient-to-br from-[#6D4C41]/20 to-[#5D4037]/15 overflow-hidden">
            ...
            <div
                ...
                style={{
                    ...
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    boxShadow: 'inset 0 0 80px rgba(109,76,65,0.4), inset 0 0 120px rgba(62,39,35,0.3)'
                }}
    ...
    >
        <div className="p-8 sm:p-12 backdrop-blur-[2px] bg-gradient-to-br from-[#4B0082]/10 to-black/30 flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#4B0082]/20 border border-[#D4AF37]/30 px-4 py-2 backdrop-blur-sm">
                    ...
                    <span className="text-sm font-medium text-[#F5E6D3]">Dari Simbol Kehormatan ke Warisan Bersama</span>
                </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-[#4B0082]/25 to-[#2D1B3D]/20 border border-[#D4AF37]/30 p-5 backdrop-blur-sm">
                    <div className="absolute -top-3 -left-2 text-5xl font-serif text-[#D4AF37]/25">"</div>
                    ...
                    <div className="absolute -bottom-3 -right-2 text-5xl font-serif text-[#D4AF37]/25 rotate-180">"</div>
                </div>
            </div>
        </div>
        <div className="relative h-64 sm:h-full bg-gradient-to-br from-[#4B0082]/15 to-[#2D1B3D]/20 overflow-hidden">
            ...
            <div
                ...
                style={{
                    background: "radial-gradient(circle at 50% 40%, rgba(212,175,55,0.2) 0%, rgba(45,27,61,0.5) 100%)",
                    boxShadow: 'inset 0 0 100px rgba(75,0,130,0.4), inset 0 0 150px rgba(26,11,46,0.4)'
                }}
                title="Batik Keraton"
            >
                <div
    ...
    >
        <div className="p-8 sm:p-12 backdrop-blur-[2px] bg-gradient-to-br from-[#0077B6]/10 to-black/30 flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#0077B6]/20 border border-[#87CEEB]/30 px-4 py-2 backdrop-blur-sm">
                    <svg className="w-4 h-4 text-[#87CEEB]" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.523-1.943A5.977 5.977 0 0116 10c0 .34-.028.675-.083 1H15a2 2 0 00-2 2v2.197A5.973 5.973 0 0110 16v-2a2 2 0 00-2-2 2 2 0 01-2-2 2 2 0 00-1.668-1.973z" clipRule="evenodd" />
                    </svg>
                    <span className="text-sm font-medium text-[#E3F2FD]">Dari Wastra Lokal ke Warisan Dunia</span>
                </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-[#0077B6]/25 to-[#1A2F42]/20 border border-[#87CEEB]/30 p-5 backdrop-blur-sm">
                    <div className="absolute -top-3 -left-2 text-5xl font-serif text-[#87CEEB]/25">"</div>
                    ...
                    <div className="absolute -bottom-3 -right-2 text-5xl font-serif text-[#87CEEB]/25 rotate-180">"</div>
                </div>
                ...
                <div className="mt-6 inline-flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-xs uppercase tracking-wider text-[#87CEEB]/70">UNESCO Recognition</div>
                        <div className="text-lg font-bold text-[#E3F2FD]">2 Oktober 2009</div>
                    </div>
                </div>
            </div>
        </div>
        <div className="relative h-64 sm:h-full bg-gradient-to-br from-[#0077B6]/15 to-[#1A2F42]/20 overflow-hidden">
            ...
            <div
                className="absolute inset-0 cursor-pointer transition-all duration-700 hover:scale-105 flex items-center justify-center"
                style={{
                    boxShadow: 'inset 0 0 100px rgba(0,119,182,0.3), inset 0 0 150px rgba(10,25,41,0.4)'
                }}
    ...
    >
        <div className="p-8 sm:p-12 backdrop-blur-[2px] bg-gradient-to-br from-[#EC4899]/10 to-black/30 flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#EC4899]/20 border border-[#FF6B9D]/30 px-4 py-2 backdrop-blur-sm">
                    <svg className="w-4 h-4 text-[#FF6B9D]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                    <span className="text-sm font-medium text-[#FCE7F3]">Dari Tradisi ke Tren Global</span>
                </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-[#EC4899]/25 to-[#2D2433]/20 border border-[#FF6B9D]/30 p-5 backdrop-blur-sm">
                    <div className="absolute -top-3 -left-2 text-5xl font-serif text-[#FF6B9D]/25">"</div>
                    <p className="relative z-10 text-sm leading-relaxed text-[#FCE7F3] italic pl-4">
                        Batik adalah gaya, bukan sekadar seragam.
                    </p>
                    <div className="absolute -bottom-3 -right-2 text-5xl font-serif text-[#FF6B9D]/25 rotate-180">"</div>
                </div>
            </div>
        </div>
        <div className="relative h-64 sm:h-full bg-gradient-to-br from-[#EC4899]/15 to-[#2D2433]/20 overflow-hidden">
            ...
            <div
                className="absolute inset-0 cursor-pointer transition-all duration-700 hover:scale-105 flex items-center justify-center"
                style={{
                    background: "radial-gradient(circle at 50% 40%, rgba(255,107,157,0.2) 0%, rgba(45,36,51,0.5) 100%)",
                    boxShadow: 'inset 0 0 100px rgba(236,72,153,0.3), inset 0 0 150px rgba(31,27,36,0.4)'
                }}
    ...
    >
        <div className="p-8 sm:p-12 backdrop-blur-[2px] bg-gradient-to-br from-[#10B981]/10 to-black/30 flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#10B981]/20 border border-[#10B981]/30 px-4 py-2 backdrop-blur-sm">
                    ...
                    <span className="text-sm font-medium text-[#D1FAE5]">Tradisi Bertemu Teknologi</span>
                </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-[#10B981]/25 to-[#134E3A]/20 border border-[#10B981]/30 p-5 backdrop-blur-sm">
                    <div className="absolute -top-3 -left-2 text-5xl font-serif text-[#10B981]/25">"</div>
                    <p className="relative z-10 text-sm leading-relaxed text-[#D1FAE5] italic pl-4">
                        Dari malam panas ke piksel cahaya.
                    </p>
                    <div className="absolute -bottom-3 -right-2 text-5xl font-serif text-[#10B981]/25 rotate-180">"</div>
                </div>
            </div>
        </div>
        <div className="relative h-64 sm:h-full bg-gradient-to-br from-[#10B981]/15 to-[#134E3A]/20 overflow-hidden">
            ...
            <div
                className="absolute inset-0 cursor-pointer transition-all duration-700 hover:scale-105 flex items-center justify-center"
                style={{
                    background: "radial-gradient(circle at 50% 40%, rgba(16,185,129,0.2) 0%, rgba(19,78,58,0.5) 100%)",
                    boxShadow: 'inset 0 0 100px rgba(16,185,129,0.3), inset 0 0 150px rgba(12,31,28,0.4)'
                }}
...
const slides: SlideDef[] = [
    
    {
        ...
        Component: SlideHero,
        background: {
            image: "linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.35)), url('/assets/hero/bg.svg')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/assets/megamendung/bg.jpg')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/assets/kawung/bg.png')",
            position: "center",
            size: "repeat",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.5)), url('/assets/sidiq/bg.jpg')",
            position: "center",
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.45)), url('/assets/community/bg.avif')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/assets/keraton/bg.png')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('/assets/unesco/bg.jpg')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55)), url('/assets/kontemporer/bg.webp')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
    ...
    },
    {
        ...
        background: {
            image: "linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('/assets/modern/bg.jpg')",
            position: "center",
            size: "cover",
        },
        parallaxLayers: [
...
export default function BatikPOCPage() {
    ...
    return (
        ...
        >
            ...
            />
            <div className="pointer-events-none absolute inset-0 bg-black/10 z-[1]" style={{
                backdropFilter: "blur(1px)",
            }} />
            {/* Decorative parallax layers */}

            <div ref={decoRef} className="decor pointer-events-none absolute inset-0 z-[15]">
